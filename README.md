...
up further than mine. I cannot measure that here. Someone I know runs this on a
node without a forwarded port and is happy with it, which is worth exactly as
much as it sounds: take the above as what the rule implies, not as a number.
